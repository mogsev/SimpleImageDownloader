...
import com.mogsev.appmvp.adapter.ItemsRecyclerViewAdapter;
import com.mogsev.appmvp.network.Api;
import com.mogsev.appmvp.network.model.Item;
import com.mogsev.appmvp.network.model.Pictures;
import com.mogsev.appmvp.utils.PaginationHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ItemsRecyclerViewAdapter mPicturesRvAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case MENU_ID_SORT_ASCENDING:
                mPicturesRvAdapter.onSort(ItemsRecyclerViewAdapter.SortType.ASCENDING);
                return true;
            case MENU_ID_SORT_DESCENDING:
                mPicturesRvAdapter.onSort(ItemsRecyclerViewAdapter.SortType.DESCENDING);
                return true;
            default:
    ...
    private void initView() {
        ...
        mPicturesRvAdapter = new ItemsRecyclerViewAdapter();
    ...
    private void handleResponse(Pictures pictures) {
        ...
        if (pictures != null) {
            ...
            if (list != null && !list.isEmpty()) {
                mPicturesRvAdapter.addAll(list);
            }
        }
        mLoading = false;
    }
